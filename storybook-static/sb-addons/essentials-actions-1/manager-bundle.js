try {
  ...
  var ct = Object.create,
    ...
    le = (e, t) =>
      function () {
        return (
          t || (0, e[Ye(e)[0]])((t = { exports: {} }).exports, t), t.exports
        )
      },
    mt = (e, t) => {
  ...
  var Mt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    Ve = ({
      ...
      return a.createElement(
        ...
        t &&
          a.createElement(Pt, null, a.createElement(Bt, { sortAscending: e }))
      )
    },
    Ft = ({
    ...
    Vt = (e) =>
      a.createElement(Ze, { nodeRenderer: Gt, dataIterator: Wt, ...e }),
    $t = ue(Vt),
    Yt = gt(yt()),
  ...
  function Rr(e, t) {
    return t === 'transparent'
      ? t
      : w(v({}, C(t), { lightness: parseFloat(e) }))
  }
  var ul = R(Rr)
  function Ar(e, t) {
    return t === 'transparent'
      ? t
      : w(v({}, C(t), { saturation: parseFloat(e) }))
  }
  var cl = R(Ar)
  function Sr(e, t) {
