    ...
    Yh.exports = function () {
      var t,
        ...
        a = {
          assert: function (o) {
            if (!a.has(o))
              throw new t_('Side channel does not contain ' + e_(o))
          },
          get: function (o) {
...
\u2028\u2029])`
      ...
      function L(w, k) {
        for (
          var N = w.replace(/^\/\*\*?/, ''), U = 0, V = new RegExp(B, 'g'), H;
          (H = V.exec(N));
      ...
      ;(function (w) {
        ...
        function K(M) {
          ...
          if (
            ...
            return null
          for (O = _(); N < M && n.code.isIdentifierPartES5(H.charCodeAt(N)); )
            O += _()
          return O
        }
        function Z(M) {
  ...
  var ur,
    ...
    vg = Ze(() => {
      ...
      ;(dR = typeof window < 'u' ? bu : he),
        (pR = function () {
          return (
            cR || (typeof __webpack_nonce__ < 'u' ? __webpack_nonce__ : void 0)
          )
        }),
        (ug = new Map()),
        (gg = function (e) {
...
`
  ...
  var j3 = Object.create,
    ...
    Ke = (e, t) =>
      function () {
        return (
          t || (0, e[e0(e)[0]])((t = { exports: {} }).exports, t), t.exports
        )
      },
    H3 = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
      ...
      `),
          ...
          : (r.add(e),
            Array.isArray(e)
              ...
              : {
                  name: 'object',
                  value: (0, Ir.default)(e, (a) => ti(a, t, new Set(r)))
                })
        : { name: 'object', value: {} }
    },
    oT = (e) => {
    ...
    dm = Ke({
      '../../node_modules/entities/lib/encode.js'(e) {
        ...
        function m(B) {
          return (
            '&#x' +
            (B.length > 1 ? b(B) : B.charCodeAt(0)).toString(16).toUpperCase() +
            ';'
          )
        }
        function g(B, I) {
        ...
        i
          ...
          : h.createElement(Oy, {
              ...
              inputElement: (x, F, B, I) =>
                I
                  ? h.createElement(iy, { onFocus: L9, onBlur: M9 })
  ...
  var nu = ja.a,
    ...
    iI = (e) => {
      ...
      return (
        ...
        r &&
          ye(`Manually specifying description type is deprecated. See ${ha}`),
        n &&
          ye(
