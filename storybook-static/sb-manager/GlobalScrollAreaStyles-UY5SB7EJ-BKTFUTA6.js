...
var getScrollAreaStyles = (theme) => ({
    ...
    'html[data-overlayscrollbars],\nhtml.os-scrollbar-hidden,\nhtml.os-scrollbar-hidden > body':
      { boxSizing: 'border-box', margin: '0', width: '100%', height: '100%' },
    ...
    '.os-scrollbar-horizontal .os-scrollbar-handle': {
      ...
      transition:
        'opacity 0.15s, background-color 0.15s, border-color 0.15s, height 0.15s'
    },
    '.os-scrollbar-vertical .os-scrollbar-handle': {
      ...
      transition:
        'opacity 0.15s, background-color 0.15s, border-color 0.15s, width 0.15s'
    },
    ...
    '.os-no-css-vars.os-theme-dark.os-scrollbar-horizontal, .os-no-css-vars.os-theme-light.os-scrollbar-horizontal':
      { padding: '2px 2px', right: '10px', height: '10px' },
