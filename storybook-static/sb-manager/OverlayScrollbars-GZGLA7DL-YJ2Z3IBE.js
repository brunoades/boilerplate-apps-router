...
function style(t2, n2) {
  ...
  if (isArray(n2) || o2) {
    ...
    if (t2) {
      ...
      s3 = o2
        ? getCSSVal(t2, e2, n2)
        : n2.reduce((n3, o3) => ((n3[o3] = getCSSVal(t2, e2, o3)), n3), s3)
    }
    return s3
  }
...
var createCache = (t2, n2) => {
  ...
  type = (t2) =>
    isUndefined(t2) || isNull(t2)
      ...
      : n
          ...
          .replace(/^\[object (.+)\]$/, '$1')
          .toLowerCase(),
  isNumber = (t2) => typeof t2 == 'number',
  isString = (t2) => typeof t2 == 'string',
  isBoolean = (t2) => typeof t2 == 'boolean',
  isFunction = (t2) => typeof t2 == 'function',
  isArray = (t2) => Array.isArray(t2),
  isObject = (t2) => typeof t2 == 'object' && !isArray(t2) && !isNull(t2),
  isArrayLike = (t2) => {
    let n2 = !!t2 && t2.length,
      o2 = isNumber(n2) && n2 > -1 && n2 % 1 == 0
    return isArray(t2) || (!isFunction(t2) && o2)
      ? n2 > 0 && isObject(t2)
        ? n2 - 1 in t2
        : !0
      : !1
  ...
  isPlainObject = (t2) => {
    if (!t2 || !isObject(t2) || type(t2) !== 'object') return !1
    let n2,
      s2 = 'constructor',
      e2 = t2[s2],
      c2 = e2 && e2.prototype,
  ...
  isHTMLElement = (n2) => {
    let o2 = HTMLElement
    return n2 ? (o2 ? n2 instanceof o2 : n2.nodeType === t) : !1
  },
  isElement = (n2) => {
    let o2 = Element
    return n2 ? (o2 ? n2 instanceof o2 : n2.nodeType === t) : !1
  ...
  is = (t2, n2) =>
    isElement(t2) ? (s.matches || s.msMatchesSelector).call(t2, n2) : !1,
  ...
  liesBetween = (t2, n2, o2) => {
    let s2 = t2 && closest(t2, n2),
      e2 = t2 && findFirst(o2, s2),
      c2 = closest(e2, n2) === s2
    return s2 && e2
      ? s2 === t2 || e2 === t2 || (c2 && closest(closest(t2, o2), n2) !== s2)
      : !1
  },
  before = (t2, n2, o2) => {
    if (o2 && t2) {
      ...
      isArrayLike(o2)
        ...
        : (e2 = o2),
        n2 && (s2 ? s2 !== n2 && (s2 = s2.nextSibling) : (s2 = t2.firstChild)),
  ...
  createDOM = (t2) => {
    let n2 = createDiv()
    return (
      (n2.innerHTML = t2.trim()), each(contents(n2), (t3) => removeElements(t3))
    )
  },
  firstLetterToUpper = (t2) => t2.charAt(0).toUpperCase() + t2.slice(1),
  getDummyStyle = () => createDiv().style,
  e = ['-webkit-', '-moz-', '-o-', '-ms-'],
  ...
  cssProperty = (t2) => {
    ...
    return (
      each(e, (e2) => {
        let c2 = e2.replace(/-/g, '')
        return !(n2 = [t2, e2 + t2, c2 + o2, firstLetterToUpper(c2) + o2].find(
          (t3) => s2[t3] !== void 0
        ))
      }),
      (i[t2] = n2 || '')
  ...
  addClass = (t2, n2) => (
    classListAction(t2, n2, (t3, n3) => t3.add(n3)), removeClass.bind(0, t2, n2)
  ),
  equal = (t2, n2, o2, s2) => {
    if (t2 && n2) {
      let e2 = !0
      return (
        each(o2, (o3) => {
          let c2 = s2 ? s2(t2[o3]) : t2[o3],
            r2 = s2 ? s2(n2[o3]) : n2[o3]
          c2 !== r2 && (e2 = !1)
        }),
        e2
      )
  ...
  directionIsRTL = (t2) => style(t2, 'direction') === 'rtl',
  ...
  on = (t2, n2, o2, s2) => {
    var e2
    let c2 = supportPassiveEvents(),
      r2 = (e2 = c2 && s2 && s2.S) != null ? e2 : c2,
      i2 = (s2 && s2.$) || !1,
      l2 = (s2 && s2.C) || !1,
      a2 = [],
  ...
  absoluteCoordinates = (t2) => {
    ...
    return n2
      ? { x: n2.left + window.pageYOffset, y: n2.top + window.pageXOffset }
      : y
  },
  ...
  mt = '__osOptionsValidationPlugin',
  xt = '__osSizeObserverPlugin',
  Tt = '__osScrollbarsHidingPlugin',
  It = '__osClickScrollPlugin',
  Lt,
  getNativeScrollbarSize = (t2, n2, o2, s2) => {
    ...
    return (
      s2 && removeElements(n2), { x: c2.h - e2.h + r2.h, y: c2.w - e2.w + r2.w }
    )
  },
  getNativeScrollbarsHiding = (t2) => {
    let n2 = !1,
      o2 = addClass(t2, O)
    try {
      n2 =
  ...
  getRtlScrollBehavior = (t2, n2) => {
    let o2 = 'hidden'
    style(t2, { overflowX: o2, overflowY: o2, direction: 'rtl' }),
      scrollLeft(t2, 0)
  ...
  createEnvironment = () => {
    let { body: t2 } = document,
      ...
      [l2] = i2(),
      a2 = getNativeScrollbarsHiding(o2),
      u2 = { x: l2.x === 0, y: l2.y === 0 },
      d2 = {
        elements: {
          host: null,
          padding: !a2,
  ...
  resolveInitialization = (t2, n2) => (isFunction(n2) ? n2.apply(0, t2) : n2),
  ...
  createStructureSetupElements = (t2) => {
    let n2 = getEnvironment(),
      ...
      Q2 = {
        ...
        ut: M2,
        dt: j2,
        ft: (t3, n3) => hasAttrClass(X2, M2 ? T : D, M2 ? n3 : t3),
        _t: (t3, n3, o3) => attrClass(X2, M2 ? T : D, M2 ? n3 : t3, o3)
      },
      tt2 = keys(Q2).reduce((t3, n3) => {
        let o3 = Q2[n3]
        return push(t3, o3 && !parent(o3) ? o3 : !1)
      }, []),
    ...
    return [
      ...
      () => {
        ...
        if (
          ...
          s2 &&
            !M2 &&
            (attrClass(et2, D, R, !0), push(it2, removeAttr.bind(0, et2, D))),
          rt2 &&
            (insertBefore(et2, rt2), push(it2, removeElements.bind(0, rt2))),
          K2)
        ) {
          let t4 = attr(et2, Pt)
  ...
  createOverflowUpdateSegment = (t2, n2) => {
    let [o2, s2] = n2,
      ...
      fixFlexboxGlue = (t3, n3) => {
        if ((style(r2, { height: '' }), n3)) {
          let { St: n4, K: s3 } = o2(),
            ...
            a3 = clientSize(e2),
            u3 = style(r2, 'boxSizing') === 'content-box',
      ...
      [H2, P2] = g2
        ...
        : [() => w3, () => [noop]]
    return (t3, n3, i3) => {
      let { gt: u3, Ot: f4, wt: g3, xt: w4, vt: M2, yt: Y2 } = t3,
        { ht: j2, bt: N2 } = o2(),
      ...
      if (
        (F3 && h2 && a2(R, L, !U2),
        W2 && ((st2 = getViewportOverflowState(U2)), fixFlexboxGlue(st2, j2)),
        u3 || w4 || g3 || Y2 || F3)
      ) {
        K2 && a2(k, A, !1)
        ...
        let _3 = { w: Rt(Mt(e3.w, u4.w) + o3.w), h: Rt(Mt(e3.h, u4.h) + o3.h) },
          h3 = {
            w: Rt((p2 ? d2.innerWidth : f5.w + Rt(l3.w - e3.w)) + o3.w),
            h: Rt((p2 ? d2.innerHeight + o3.h : f5.h + Rt(l3.h - e3.h)) + o3.h)
          }
      ...
      if (w4 || Y2 || dt2 || at2 || ct2 || it2 || X2 || F3 || W2) {
        let t4 = {
          ...
          n4 = setViewportOverflowState(U2, ft2, G2, t4),
          o3 = H2(n4, lt2, ut2, N2)
  ...
  createStructureSetupUpdate = (t2, n2) => {
  ...
  createEventContentChange = (t2, n2, o2) => {
    let s2,
      e2 = !1,
      destroy = () => {
        e2 = !0
    ...
    return (
      o2 && ((s2 = new WeakMap()), updateElements()), [destroy, updateElements]
    )
  },
  createDOMObserver = (t2, n2, o2, s2) => {
    let e2 = !1,
      ...
      [_2, h2] = createEventContentChange(t2, f3, i2),
      v3 = c2 || [],
      g2 = r2 || [],
      w3 = v3.concat(g2),
          ...
          (each(e3, (o3) => {
            ...
            if (n2 && (b3 || !m2)) {
              let n3 = !p3,
                ...
                f5 = u4 && a2 && is(c4, a2),
                g3 =
                  (f5 ? !r3(c4, e4, d3, y2) : n3 || u4) && !i3(o3, !!f5, t2, s2)
  ...
  createSizeObserver = (t2, n2, o2) => {
    let { Bt: s2 = !1, Vt: e2 = !1 } = o2 || {},
      c2 = getPlugins()[xt],
      { B: r2 } = getEnvironment(),
      l2 = createDOM(`<div class="${j}"><div class="${q}"></div></div>`)[0],
      a2 = l2.firstChild,
      ...
      onSizeChangedCallbackProxy = (t3) => {
        ...
        if (o3) {
          let [n3, , o4] = f3(t3.pop().contentRect),
            ...
            e4 = domRectHasDimensions(o4)
          ;(c3 = !o4 || !s3), (i3 = !e4 && s3), (a3 = !c3)
        } else e3 ? ([, a3] = t3) : (i3 = t3 === !0)
        if (s2 && a3) {
      ...
      _2 = [],
      h2 = e2 ? onSizeChangedCallbackProxy : !1
    return [
      () => {
      ...
      () => {
          ...
          push(
            ...
            on(l2, 'scroll', (n3) => {
              ...
              e3 &&
                ...
                s3 ? addClass(a2, 'rtl') : addClass(a2, 'ltr'),
        ...
        h2 &&
          (addClass(l2, N), push(_2, on(l2, 'animationstart', h2, { C: !!u }))),
          (u || c2) && appendChildren(t2, l2)
      }
    ]
  },
  isHeightIntrinsic = (t2) =>
    t2.h === 0 || t2.isIntersecting || t2.intersectionRatio > 0,
  createTrinsicObserver = (t2, n2) => {
    let o2,
      s2 = createDiv(U),
      e2 = [],
      [c2] = createCache({ o: !1 }),
      triggerOnTrinsicChangedCallback = (t3, o3) => {
        if (t3) {
          let s3 = c2(isHeightIntrinsic(t3)),
            [, e3] = s3
    ...
    return [
      ...
      () => {
        if (a)
          (o2 = new a((t3) => intersectionObserverCallback(t3), { root: t2 })),
            o2.observe(s2),
            push(e2, () => {
              o2.disconnect()
            })
      ...
      () => {
        if (o2) return intersectionObserverCallback(o2.takeRecords(), !0)
      }
    ]
  },
  qt = `[${T}]`,
  ...
  createStructureSetupObservers = (t2, n2, o2) => {
    let s2,
      ...
      [p2, b3, m2] =
        l2 || !h2
          ? createTrinsicObserver(r2, onTrinsicChanged)
          : [noop, noop, noop],
      [y2, S3] = d2
        ? [noop, noop]
      ...
      [
        ...
        () => {
          ...
          return (
            ...
            s3 && assignDeep(t3, onContentMutation.apply(0, push(s3, !0))),
            t3
          )
        },
        (t3) => {
          let [n3] = t3('update.ignoreMutation'),
            ...
            h3 = u2 || r3,
            ignoreMutationFromOptions = (t4) => isFunction(n3) && n3(t4)
          if (
            (h3 &&
              (c2 && (c2[1](), c2[0]()),
              (c2 = createDOMObserver(l2 || i2, !0, onContentMutation, {
                ...
                kt: (t4, n4) => {
                  ...
                  return (
                    (!n4 && s3 && !d2 ? liesBetween(o4, qt, Ft) : !1) ||
                    !!closest(o4, `.${J}`) ||
                    !!ignoreMutationFromOptions(t4)
                  )
                }
              }))),
            _3)
            ...
            if ((w3.m(), isArray(f4))) {
              ...
              isNumber(f4) ? ((s2 = f4), (e2 = !1)) : ((s2 = !1), (e2 = !1))
        }
      ]
    )
  },
  Wt = { x: 0, y: 0 },
  createInitialStructureSetupUpdateState = (t2) => ({
    K: { t: 0, r: 0, b: 0, l: 0 },
    St: !1,
    P: {
      marginRight: 0,
  ...
  createStructureSetup = (t2, n2) => {
    let o2 = createOptionCheck(n2, {}),
      ...
      a2 = createState(createInitialStructureSetupUpdateState(r2)),
      [u2, d2] = a2,
      f3 = createStructureSetupUpdate(r2, a2),
  ...
  createInteractiveScrollEvents = (t2, n2, o2, s2, e2, c2, r2) => {
    let { B: i2 } = getEnvironment(),
      ...
      v3 = r2 ? 'w' : 'h',
      g2 = r2 ? 'x' : 'y',
      createRelativeHandleMove = (t3, n3) => (o3) => {
        let { Tt: s3 } = c2(),
    ...
    return on(a2, 'pointerdown', (s3) => {
      let c3 = closest(s3.target, `.${ot}`) === l2,
        r3 = c3 ? l2 : a2
      if ((attrClass(n2, T, H, !0), continuePointerDown(s3, t2, c3))) {
        let t3 = !c3 && s3.shiftKey,
          ...
          i3 = createRelativeHandleMove(e2[d2] || 0, 1 / getScale(e2)[g2]),
          u3 = s3[f3],
          v4 = getHandleRect(),
          w3 = getTrackRect(),
          p2 = v4[_2],
  ...
  createScrollbarsSetupEvents = (t2, n2) => (o2, s2, e2, c2, r2, i2) => {
    let { Xt: l2 } = o2,
  ...
  getScrollbarHandleOffsetRatio = (t2, n2, o2, s2, e2, c2) => {
  ...
  createScrollbarsSetupElements = (t2, n2, o2) => {
    let { N: s2, L: e2 } = getEnvironment(),
      { scrollbars: c2 } = s2(),
      { slot: r2 } = c2,
      { ct: i2, W: l2, Z: a2, J: u2, lt: d2, ot: f3, it: h2, ut: v3 } = n2,
      { scrollbars: g2 } = d2 ? {} : t2,
      { slot: w3 } = g2 || {},
      ...
      scrollbarStructureRefreshHandleOffset = (t3, n3, o3) => {
        ...
        scrollbarsHandleStyle(t3, (t4) => {
          let { Ft: e3, Gt: c3, Xt: r3 } = t4,
            i3 = getScrollbarHandleOffsetRatio(
              e3,
              c3,
              f3,
              n3,
  ...
  createScrollbarsSetup = (t2, n2, o2, s2) => {
    let e2,
      ...
      [S3, x2, $2] = createScrollbarsSetupElements(
        t2,
        o2.qt,
        createScrollbarsSetupEvents(n2, o2)
      ),
  ...
  OverlayScrollbars = (t2, n2, o2) => {
    ...
    if (n2 && !u2) {
      let u3 = !1,
        ...
        $2 = {
          options(t3, n3) {
            if (t3) {
              let o3 = n3 ? s2() : {},
                e3 = getOptionsDiff(d2, assignDeep(o3, validateOptions(t3)))
          ...
          elements() {
            let { W: t3, Z: n3, K: o3, J: s3, tt: e3, ot: c3, st: r3 } = g2.qt,
              { Jt: i3, nn: l3 } = b3.qt,
      ...
      return (
        ...
        cancelInitialization(g2.qt.it, e2().cancel, !l2 && t2.cancel)
          ? (destroy(!0), $2)
          : (g2.Nt(),
            b3.Nt(),
            h2('initialized', [$2]),
...
var O2 = () => {
    ...
    let l2,
      c2,
      t2 = window,
      o2 = typeof t2.requestIdleCallback == 'function',
  ...
  S2 = (l2) => {
    let { options: c2, events: t2, defer: o2 } = l2 || {},
      [a2, i2] = (0, import_react.useMemo)(O2, []),
      r2 = (0, import_react.useRef)(null),
      u2 = (0, import_react.useRef)(o2),
      s2 = (0, import_react.useRef)(c2),
      n2 = (0, import_react.useRef)(t2)
    return (
  ...
  F2 = (l2, c2) => {
    let {
      ...
      s2 = t2,
      n2 = (0, import_react.useRef)(null),
      e2 = (0, import_react.useRef)(null),
      [y2, d2] = S2({ options: o2, events: a2, defer: i2 })
    return (
      (0, import_react.useEffect)(() => {
        let { current: I2 } = n2,
          { current: m2 } = e2
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement('div', { ref: e2 }, r2)
      )
    )
  },
  A2 = (0, import_react.forwardRef)(F2),
